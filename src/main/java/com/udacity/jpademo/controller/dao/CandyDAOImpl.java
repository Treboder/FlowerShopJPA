...
public class CandyDAOImpl implements CandyDAO {
    ...
    @Autowired
    NamedParameterJdbcTemplate jdbcTemplate; // IntelliJ says: "could not autowire. No bean for NamedParameterJdbcTemplate found
    ...
    private static final String FIND_CANDY_BY_DELIVERY = "SELECT c.* FROM candy_delivery AS cd " +
